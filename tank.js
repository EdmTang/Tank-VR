let casemate,casemate1;
class Tank{
	constructor(x,y,z,rx,ry,rz){
		casemate=document.createElement("a-entity");
	  ...
	  hull.append(comp1);
		...
		casemate.append(turret);
		casemate.append(hull);
		casemate.setAttribute("position",{x:x,y:y,z:z});
		casemate.setAttribute("rotation",{x:rx,y:ry,z:rz});
		...
		this.rTrackHB.setAttribute("height","3");
		this.rTrackHB.setAttribute("position",{x:xrTB,y:yrTB,z:zrTB});
		this.rTrackHB.setAttribute("rotation",{x:rx,y:ry,z:rz});
		scene.append(this.rTrackHB);
		...
		this.lTrackHB.setAttribute("height","3");
		this.lTrackHB.setAttribute("position",{x:xlTB,y:ylTB,z:zlTB});
		this.rTrackHB.setAttribute("rotation",{x:rx,y:ry,z:rz});
		scene.append(this.lTrackHB);
		
		scene.append(casemate);
	}
}

function tankTrack(x,y,z){
